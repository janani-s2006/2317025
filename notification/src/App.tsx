...
function App() {
  ...
  const exampleNotifications:Notification[]=[
    {id:1,message:'Info notification 1',type:'info',priority:1},
    {id:2,message:'Warning notification 1',type:'warning',priority:2},
    {id:3,message:'Error notification 1',type:'error',priority:3},
    {id:4,message:'Info notification 2',type:'info',priority:4},
    {id:5,message:'Warning notification 2',type:'warning',priority:5},
  ];
  React.useEffect(()=>{
